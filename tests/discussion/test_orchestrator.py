...
from qubettera.discussion.fakes import DeterministicAgentRuntime
from qubettera.discussion.orchestrator import DiscussionExecutionError, DiscussionOrchestrator
...
class ConcurrentRuntime(DeterministicAgentRuntime):
    def __init__(self):
        super().__init__()
...
def test_parallel_stages_keep_deterministic_message_order(tmp_path):
