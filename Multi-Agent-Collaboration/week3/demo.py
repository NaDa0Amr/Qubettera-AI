...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--graph", default="configs/agent_graph.json")
    parser.add_argument("--discussion", default="configs/discussion.json")
    parser.add_argument("--output-dir", default="outputs/week3")
    parser.add_argument(
        "--topology",
